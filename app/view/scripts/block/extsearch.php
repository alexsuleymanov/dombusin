...
//			console.log($("#extsearch").attr('action')+$("#extsearch").serialize()+'&getnum=1');
...
$Prod = new Model_Prod();
$condp = array(
	"select" => "id, pop, mix, skidka, onsale, uploaded",
					...
					<tr>
						<td valign="top">
							<table cellspacing="0" cellpadding="0" border="0" width="90%">
								...
								<tr>
									<td class="char">
										<input type="checkbox" name="sale" value="action" <? if ($this->sale == 'action') echo "checked"; ?>> Акционные товары
									</td>
								</tr>
								<tr>
									<td class="char">
										<input type="checkbox" name="sale" value="new" <? if ($this->sale == 'new') echo "checked"; ?>> Новинки
									</td>
								</tr>
								<tr>
									<td class="char">
										<input type="checkbox" name="sale" value="pop" <? if ($this->sale == 'pop') echo "checked"; ?>> Топ продаж
									</td>
								</tr>
								<tr>
									<td class="char">
										<input type="checkbox" name="sale" value="mix" <? if ($this->sale == 'mix') echo "checked"; ?>> Миксы
									</td>
								</tr>
								<tr>
									<td class="char">
										<input type="checkbox" name="sale" value="onsale" <? if ($this->sale == 'onsale') echo "checked"; ?>> Снова в продаже
									</td>
								</tr>								
							</table>
						</td>

...
//				echo "".$date.";".$order->id.";".$name.";".$art.";".$prod_name.";".$inpack1.";".$num1.";".$price1.";".$sum1.";".$inpack2.";".$num2.";".$price2.";".$sum2.";".$inpack3.";".$num3.";".$price3.";".$sum3."\n";
			...
			foreach($export as $v){				
				echo $v['date'].";".$v['order'].";".$v['name'].";".$v['email'].";".$v['art'].";".$v['prod_name'].";".$v['inpack1'].";".$v['num1'].";".$v['price1'].";".$v['sum1'].";".$v['inpack2'].";".$v['num2'].";".$v['price2'].";".$v['sum2'].";".$v['inpack3'].";".$v['num3'].";".$v['price3'].";".$v['sum3'].";".$phone."\n";
			}
